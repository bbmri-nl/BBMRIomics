...
$RSCRIPT genotyping.R --typex RNA --cohort ALL --out ${OUT} --filex ${OUT}/output.vcf

##inter
$RSCRIPT genotyping.R --typex RNA --typey HRC --cohort ALL --out ${OUT} --filex ${OUT}/output.vcf
$RSCRIPT genotyping.R --typex RNA --typey GoNL --cohort $cohort --out ${OUT}
...
$RSCRIPT genotyping.R --typex HRC --typey GoNL --cohort ALL --filex ${OUT}/HighQualPositions.GCRh37.bed
