...
<!-- Set "eval=FALSE" for chunk below as execution dd 2017-03-22 18:12 yielded: -->
<!-- -- -->
...
<!-- Set "eval=FALSE" for chunk below as execution dd 2017-03-22 18:16 yielded: -->
<!-- -- -->
<!-- Error in value[[jvseq[[jjj]]]] : subscript out of bounds -->
<!-- Calls: <Anonymous> ... eval -> eval -> molgenis.get.all -> [<- -> [<-.data.frame -->
<!-- Execution halted -->
<!-- -- -->
<!-- ```{r, laclevels} -->
