...
rdb <- getSQLview("getStats", usrpwd=RP3_MDB_USRPWD)
...
##add genotype ids
imputation <- getSQLview("getImputations", usrpwd=RP3_MDB_USRPWD)
...
ids <- getSQLview("getIds", usrpwd=RP3_MDB_USRPWD)
...
rna <- getSQLview("getRNASeqRuns", usrpwd=RP3_MDB_USRPWD)
