...
rdb <- getView("getStats", usrpwd=RP3_MDB_USRPWD)
...
##add genotype ids
imputation <- getView("getImputations", usrpwd=RP3_MDB_USRPWD)
...
ids <- getView("getIds", usrpwd=RP3_MDB_USRPWD)
...
rna <- getView("getRNASeqRuns", usrpwd=RP3_MDB_USRPWD)
