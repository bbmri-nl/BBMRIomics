...
<!-- Dd 2017-03-20 18:21 evaluation of the chunk below yields: -->
<!-- -- -->
<!-- Error in colData(metabolomicData) : object 'metabolomicData' not found -->
<!-- Calls: <Anonymous> ... withCallingHandlers -> withVisible -> eval -> eval -> head -> colData -->
<!-- Execution halted -->
<!-- -- -->
<!-- ==> Set "eval=FALSE" for this chunk (HD). -->
<!-- ```{r metabolomic} -->
```{r metabolomic, eval=FALSE}
