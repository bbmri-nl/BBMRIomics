...
#
#
### START Code commented dd 2017-03-21 17:18 (HD) -- commented as apparently successful loading of data set "methData_Betas_CODAM_F2_cleaned" yields "errmessage == 'methData_Betas_CODAM_F2_cleaned'", too.
# #
# errmessage <- try(utils::data(methData_Betas_CODAM_F2_cleaned))
# #
# if (errmessage == "methData_Betas_CODAM_F2_cleaned") {
#   stop("data set 'methData_Betas_CODAM_F2_cleaned' not found")
# }
# # 
# #END Code amended from "./EWAS.Rmd" dd 2017-03-20 18:47 (HD).
# #
### END Code commented dd 2017-03-21 17:18 (HD).
...
#
# errmessage <- try(utils::data(rnaSeqData_ReadCounts_cleaned))
# #
# if (errmessage == "rnaSeqData_ReadCounts_cleaned") {
#   stop("data set 'rnaSeqData_ReadCounts_cleaned' not found")
# }
#
