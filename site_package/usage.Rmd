...
## Inspect phenotypes and metadata: `colData` ##
...
Not all phenotypic data is complete.

```{r}
per.complete[per.complete == 0] ##complete
per.complete[per.complete == 100] ##completely missing
per.complete[per.complete > 0 & per.complete < 100] ##partial missing
```

## Inspect feature information: `rowRanges` ##
