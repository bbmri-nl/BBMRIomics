...
data, detailed technical information on data generation is provided,
such as sequencing machine, flow-cell, array position on the chip,
date of hybridization. Furthermore, phenotypic data on the individual
level such as blood measures of cholesterol, C-reactive protein, and
blood cell count. But also lifestyle factors as smoking, alcohol use
in addition to antropometric measures as body mass index.
