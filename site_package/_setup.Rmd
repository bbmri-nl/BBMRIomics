...
suppressPackageStartupMessages({ ##to get rid of annoying startup messages (like ours ;)!)
  ...
  #REF email from Maarten van Iterson dated 2017-03-21 14:59:36 (REM HD dd 2017-03-21 16:16 : This is for the purpose of running "$ make render" from the Ubuntu command prompt on in "/virdir/Scratch/~" 'the BIOS VM' [REF "http://bios-vm.bbmrirp3-lumc.surf-hosted.nl/BBMRIomics/contribute.html"]):
  #====
