...
ggsave(file.path("/virdir/Scratch/RP3_analysis/imputed_phenotypes", "Sex_RNAseq_eval.eps"))
...
setEPS()
postscript("/virdir/Scratch/RP3_analysis/imputed_phenotypes/Sex_RNAseq_feats.eps")
...
phenotyped <- phenotyping(phenotype, features, methods = "lasso", ntop=100, verbose=TRUE)
...
ggsave(file.path("/virdir/Scratch/RP3_analysis/imputed_phenotypes", "Age_RNAseq_eval.eps"))
